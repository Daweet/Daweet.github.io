...
By preparing the system to be initially on the ground state \$0\$, one
can transfer 100% of the population to state \$2\$. When we say
population what we refer to is the mean photon number. To do so we
couple the states, via the pulses, counter intuitively, that is we first
couple the states $|1\rangle$ and $|2\rangle$ using the Stokes pulse,
and later we couple states $|0\rangle$ and $|1\rangle$, using pump
laser. STIRAP is robust in that it is insensitive to the decaying
...
[]<span>@lcl@</span> Input\_1 Stokes & Input\_2 Pump & Output state 20 &
0 & 00 & 1 & 01 & 0 & 01 & 1 & 1
...
Population on state 20 & 0 & 00 & 1 & 11 & 0 & 11 & 1 & 1
